...
// points somewhere that 404s until a later unit ships it (Work and Craft in
// U7-U8), so prefetching those would fire a background RSC request that
...
const EXISTING_ROUTES = new Set(["/about", "/contact", "/writing"])
